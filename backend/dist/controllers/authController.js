...
const registerUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (userExists) {
            (0, response_1.sendError)(res, 400, "Email is already registered");
            return;
        }
        ...
        (0, response_1.sendSuccess)(res, 201, {
            id: user._id,
            name: user.name,
            email: user.email,
            token,
...
const loginUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        if (!email || !password) {
            (0, response_1.sendError)(res, 400, "Email and password are required");
            return;
        }
...
const updateUserProfile = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (req.body.name && !(0, validation_1.validateName)(req.body.name)) {
            errors.push("Name must be at least 2 characters long");
        }
        // Validate email if provided
        if (req.body.email && !(0, validation_1.validateEmail)(req.body.email)) {
            errors.push("Please provide a valid email address");
        }
        // Validate password if provided
        if (req.body.password) {
            const passwordValidation = (0, validation_1.validatePassword)(req.body.password);
            if (!passwordValidation.valid) {
                errors.push(...passwordValidation.errors);
            }
        }
        ...
        const token = (0, generateToken_1.default)(updatedUser._id);
        (0, response_1.sendSuccess)(res, 200, {
            id: updatedUser._id,
